...
namespace StudentsEmployees.Controllers
{
    public class StudentController : Controller
    {
        ...
        public List<Student> studentList = new List<Student>() {
                new Student() { ID = 1, Name = "Test1", Age = 20,Branch = "CSIT", Gender = "FeMale"},
                new Student() { ID = 2, Name = "Test2", Age = 22,Branch = "BIM", Gender = "Male" },
                new Student() { ID = 3, Name = "test1", Age = 20,Branch = "BBA", Gender = "FeMale" }
            };
